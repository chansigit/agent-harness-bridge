...
```bash
pip install 'agent-harness-bridge[openai]==0.2.13'
pip install 'agent-harness-bridge[claude]==0.2.13'
pip install 'agent-harness-bridge[deepseek]==0.2.13'
pip install 'agent-harness-bridge[all]==0.2.13'
```
